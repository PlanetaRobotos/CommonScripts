...
namespace submodules.CommonScripts.CommonScripts.Utilities.Editor
{
    public static class Shortcuts
    {
        ...
        private static void InitToggleInspectorLock()
        {
            ...
            inspectorType = Assembly.GetAssembly(typeof(UnityEditor.Editor)).GetType("UnityEditor.InspectorWindow");
